...
# kita perlu mengurutkan DataFrame berdasarkan order_date serta memastikan kedua kolom tersebut bertipe datetime. 
...
# menambahkan filter pada dashboard yang akan dibuat
